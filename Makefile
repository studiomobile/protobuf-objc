...
target_triplet = i386-apple-darwin9.8.0
subdir = .
...
ACLOCAL = ${SHELL} /Projects/protobuf-2.2.0/missing --run aclocal-1.10
AMTAR = ${SHELL} /Projects/protobuf-2.2.0/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /Projects/protobuf-2.2.0/missing --run autoconf
AUTOHEADER = ${SHELL} /Projects/protobuf-2.2.0/missing --run autoheader
AUTOMAKE = ${SHELL} /Projects/protobuf-2.2.0/missing --run automake-1.10
AWK = awk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Projects/protobuf-2.2.0/missing --run makeinfo
...
STRIP = strip
VERSION = 2.2.0
abs_builddir = /Projects/protobuf-2.2.0
abs_srcdir = /Projects/protobuf-2.2.0
abs_top_builddir = /Projects/protobuf-2.2.0
abs_top_srcdir = /Projects/protobuf-2.2.0
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = $(SHELL) /Projects/protobuf-2.2.0/install-sh
